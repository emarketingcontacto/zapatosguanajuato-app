...
class Factories extends Controller
{
    ...
    public function __invoke(Request $request){
        ...
        */
        ...
        return view('Factories.Factories', ['business'=>$business, 'bizcat' => $bizcat]);
    }

    public function showFabricante(string $fabricante , Request $request){
        //dd($fabricante);
        $biz = Biz::where('bizSlug', $fabricante )->first();
       ...
       if($request->modelsubcatname === null)
       {
        ...
        return view('Factories.Factories-detail',['biz'=>$biz, 'bizcat'=>$bizcat, 'saletype'=>$saletype, 'modelos'=>$modelos, 'modelcategories'=>$modelcategories]);
    ...
    public function showGenero(string $genero, Request $request){
        // dd($genero);
        //variables
        $bizcategory='Fabricante';
        $modelcategory ='';
        $viewPage='';
        switch ($genero) {
            case 'mujer':
                $modelcategory = 'Damas';
                $viewPage = "Factories.damas";
                break;

            case 'hombres':
                $modelcategory = 'Hombres';
                $viewPage = "Factories.hombres";
                break;

            case 'ninos':
                $modelcategory = 'Niños';
                $viewPage = "Factories.ninos";
                break;

            case 'ninas':
                $modelcategory = 'Niñas';
                    $viewPage = "Factories.ninas";
                break;
    ...
    public function showTipo(string $genero, string $tipo, Request $request){
        ...
        return view('Factories.tipo',['modelsfactories'=>$modelsfactories,'bizcategory'=>$bizcategory, 'tipo'=>$tipo, 'genero'=>$genero]);
    }
