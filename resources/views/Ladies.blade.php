@php
   $description ="Encuentra Proveedores, Promociones y Modelos Exclusivos, Contacto y Ubicación y de los mejores proveedores de calzado para damas en Guanajuato. ¡Haz negocio ahora mismo!";
    $keywords= "Venta de zapatos para Dama en Guanajuato";
@endphp
<x-layout pageTitle="Calzado para Damas en Guanajuato - Zapatos Guanajuato" pageDescription={{$description}} keywords={{$keywords}}>
    ...
    <div class="intro">
        <h2>
            <strong>Directorio de Proveedores de Calzado para Damas </strong> calidad y precios de fábrica para distribuidores
        </h2>
    </div>
    <div class="intro-text">
        <h3>
            Encuentra los mejores <strong>proveedores de Calzado para Dama del Estado de Guanajuato</strong> a los mejores precios
        </h3>
    </div>
    {{-- end intro text --}}
    ...
    {{-- Wholesalers --}}
    <div class="factories-modelsubcat">
        <div class="genders-category-container" id="mayoristas">
