...
<head>
    ...
    {{-- seo --}}
        <meta name="description" content="Categoria de Negocios Index"/>
        <meta name="keywords" content="Categoria de Negocios Index"/>
        <title>Categoria de Negocios  | ZapatosGuanajuato.com</title>
        {{-- canonical --}}
            <script>
