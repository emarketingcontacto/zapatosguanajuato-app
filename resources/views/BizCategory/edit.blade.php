...
<head>
    ...
    {{-- seo --}}
        <meta name="description" content="Editar Categoria de Negocios"/>
        <meta name="keywords" content="Editar Categoria de Negocios"/>
        <title> Editar Categoria de Negocios | ZapatosGuanajuato.com</title>
        {{-- canonical --}}
            <script>
