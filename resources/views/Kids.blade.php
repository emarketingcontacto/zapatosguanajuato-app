@php
    $description ="Directorio de Zapatos para Niños hecho en Guanajuato. Encuentra contactos de fabricantes y mayoristas de calzado para niños en Guanajuato. ¡Emprende tu negocio hoy!";
    $keywords = "Venta de zapatos para Hombres en Guanajuato, Directorio de zapatos para Niños, Venta de zapatos para niños a precio de mayoreo";
@endphp

<x-layout pageTitle="Directorio de Zapatos para Niños de Guanajuato" pageDescription={{$description}} keywords={{$keywords}}>

    @section('main-content')

        <div class="header-Category" style="background-image: url('{{asset('storage/'.$modelcat->modelcatImage)}}')" alt="DirectorioNiños">
            <h1>Directorio de Calzado de Guanajuato para Niños</h1>
        </div>
 {{-- intro text --}}
 <div class="intro">
    <h2>
