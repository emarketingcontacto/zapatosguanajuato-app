...
<head>
    ...
    {{-- seo --}}
        <meta name="description" content="Modelo Categoria Editar"/>
        <meta name="keywords" content="Modelo Categoria Editar"/>
        <title>Modelo Categoria Editar | ZapatosGuanajuato.com</title>
        {{-- canonical --}}
            <script>
