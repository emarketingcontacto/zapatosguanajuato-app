...
<head>
    ...
    {{-- seo --}}
        <meta name="description" content="Modelo Categoria Index"/>
        <meta name="keywords" content="Modelo Categoria Index"/>
        <title>Modelo Categoria Index | ZapatosGuanajuato.com</title>
        {{-- canonical --}}
            <script>
