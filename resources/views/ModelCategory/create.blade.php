...
<head>
    ...
    {{-- seo --}}
        <meta name="description" content="Modelo Categoria Crear"/>
        <meta name="keywords" content="Modelo Categoria Crear"/>
        <title>Modelo Categoria Crear | ZapatosGuanajuato.com</title>
        {{-- canonical --}}
            <script>
