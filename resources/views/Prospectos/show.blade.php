...
<head>
    ...
    {{-- seo --}}
        <title>Prospectos Show | ZapatosGuanajuato.com</title>
        <meta name="description" content="Prospectos Show"/>
        <meta name="keywords" content="Prospectos Show"/>
    {{-- end seo --}}
            ...
            <div class="admin-container">
                <div class="prospects-data-container">
                    ...
                    <div class="admin-control-buttons">
                            <a href="{{route('Prospectos.edit', [$prospect->prospectoId])}}" class="btn btn-sm btn-primary">Editar</a>
