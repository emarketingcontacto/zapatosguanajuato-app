@php
    $description ="Encuentra Proveedores, Promociones y Modelos Exclusivos, Contacto y Ubicación y de los mejores proveedores de calzado para hombres en Guanajuato. ¡Haz negocio ahora mismo!";
    $keywords= "Venta de zapatos para Hombres en Guanajuato, Directorio de zapatos para hombres, Venta de zapatos a precio de mayoreo";
@endphp
<x-layout pageTitle="Directorio de Fabricantes Zapatos Guanajuato" pageDescription={{$description}} keywords={{$keywords}}>

    @section('main-content')

    <div class="header-Category" style="background-image: url('{{asset('storage/'.$modelcat->modelcatImage)}}')" alt="DirectorioDamas">
        <h1>Directorio de Calzado Guanajuato para Hombres</h1>
    </div>
 {{-- intro text --}}
 <div class="intro">
    <h2>
        <strong>Proveedores de calzado para Hombres </strong> calidad y precios de fábrica para distribuidores
    </h2>
</div>
<div class="intro-text">
    <h3>
        Encuentra los mejores proveedores de calzado para Hombres a los mejores precios del Estado de Guanajuato.
    </h3>
</div>
{{-- end intro text --}}
...
<div class="factories-modelsubcat">
    <div class="genders-category-container">
        <div class="genders-category-title" id="fabricantes">
            <h4>Fabricantes de calzado para hombres</h4>
        </div>
    </div>
        ...
        <div class="factories-item">
            ...
            <div class="gallery-image">
                <a href="{{route('Modelo.show', ['modelo'=>$factory->modelId])}}">
                    ...
                    {{-- online --}}
                    <img src="{{asset('/'.$factory->modelImage)}}" alt="{{$factory->modelName}}" width="255vw" height="255vh">
                </a>
            </div>
...
<div class="factories-modelsubcat">
    <div class="genders-category-container">
        <div class="genders-category-title" id="mayoristas">
            <h4>Mayoristas de calzado para hombres</h4>
        </div>
    </div>
        ...
        <div class="factories-item">
            ...
            <div class="gallery-image">
                <a href="{{route('Modelo.show', ['modelo'=>$wholesaler->modelId])}}">
                    ...
                    {{-- online --}}
                    <img src="{{asset('/'.$wholesaler->modelImage)}}" alt="{{$wholesaler->modelName}}" width="255vw" height="255vh">
                </a>
            </div>
            <div class="card-text gallery-biz-name">
                <div class="row modelo-row">
 ...
 <div class="factories-modelsubcat">
    <div class="genders-category-container">
        <div class="genders-category-title" id="minoristas">
            <h4>Minoristas de calzado para hombres</h4>
        </div>
    </div>
        ...
        <div class="factories-item">
            ...
            <div class="gallery-image">
                <a href="{{route('Modelo.show', ['modelo'=>$retail->modelId])}}">
                    ...
                    {{-- online --}}
                    <img src="{{asset('/'.$retail->modelImage)}}" alt="{{$retail->modelName}}" width="255vw" height="255vh">
                </a>
            </div>
            <div class="card-text gallery-biz-name">
                <div class="row modelo-row">
