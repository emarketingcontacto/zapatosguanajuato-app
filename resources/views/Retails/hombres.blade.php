...
<html lang="es">
    <head>
        ...
        {{-- seo --}}
            <title>Comprar Calzado para Hombres de Guanajuato | Venta por Catálogo y Tiendas Online</title>
            <meta name="keywords" content="Comprar zapatos de Hombres Guanajuato Menudeo en línea, venta de zapatos por catálogo, tiendas online de calzado masculino"/>
            <meta name="description" content="Directorio Tiendas en Línea para Comprar Calzado Menudeo Hombres de Guanajuato. Encuentra las últimas colecciones, precios finales con envío a domicilio."/>
            <link rel="canonical" href="{{URL::asset('/minoristas-calzado-guanajuato/genero/hombres')}}">
        {{-- end seo --}}
    ...
    <x-layout>
        ...
        @section('main-content')
            ...
            <div class="genders-hero" style="background-image: url('{{asset('storage/'.$modelcat->modelcatImage)}}')" alt="DirectorioDamas">
                <h1>Directorio de Minoristas de Calzado Guanajuato para Hombres</h1>
                {{-- call to action --}}
            ...
            {{-- intro text --}}
                <div class="genders-intro-container">
                    <div class="genders-intro">
                        <h2 class="seo-title">Minoristas de Calzado para hombres: Compra al Menudeo con Envío</h2>
                        <p>
                            Bienvenido al directorio de <strong>tiendas online</strong> especializadas en <strong>calzado para hombre</strong> de León, Guanajuato. Si buscas moda, calidad y deseas
                            <strong>comprar zapatos en línea</strong> a <strong>precios de menudeo</strong>, aquí te conectamos con las mejores colecciones.
                        </p>
                        <p>
                            Esta sección te ofrece acceso directo a <strong>minoristas de calzado</strong> que venden de forma individual, con la flexibilidad de <strong>comprar por catálogo</strong> o desde
                            sus plataformas en línea. Olvídate de los mínimos de compra y disfruta de la variedad de la piel de Guanajuato.
                        </p>
                        <p>
                            Explora las categorías específicas para <strong>hombre</strong> y accede a los <strong>precios finales</strong> sin intermediarios.
                            La calidad de la manufactura de Guanajuato al alcance de un clic.
                        </p>
                        <p>
                            Encuentra esa marca exclusiva que buscas y recibe tus zapatos en la comodidad de tu hogar.
                        </p>
                    </div>
                </div>
            {{-- end intro text --}}
            ...
            <div class="genders-submenu-container">
                ...
                {{-- submenu Genero --}}
                    <x-search-model-category bizcategory="Retails" genero="hombres"></x-search-model-category>
                {{-- end submenu Genero --}}

                {{-- subcategories submenu --}}
                <x-submenu-subcategories categoria="Retails" genero="hombres" tipo=""></x-submenu-subcategories>
