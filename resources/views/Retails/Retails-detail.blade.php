...
<head>
    ...
    {{-- seo --}}
        <title>Venta Calzado en Linea {{$biz->bizName }}|ZapatosGuanajuato.com</title>
        ...
        <meta name="keywords" content="Venta Calzado en Linea , Venta por Catalogo de {{$bizcat->bizcatName}} - {{$biz->bizName}}, Zapatos en Guanajuato"/>
        <link rel="canonical" href="{{URL::asset('/minoristas-calzado-guanajuato/'.$biz->bizSlug)}}">
    {{-- end seo --}}
