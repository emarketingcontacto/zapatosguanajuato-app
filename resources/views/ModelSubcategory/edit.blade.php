...
<head>
    ...
    {{-- seo --}}
    <title>Modelo Subcategoria Editar | ZapatosGuanajuato.com</title>
    <meta name="description" content="Modelo Subcategoria Editar"/>
    <meta name="keywords" content="Modelo Subcategoria Editar"/>
    {{-- end seo --}}
    ...
    <div class="admin-container-control">
        ...
        <form action="{{route('ModelSubcategory.update',['modelsubcategory'=>$modelsubcategory])}}" method="POST">
            ...
            <div class="mb-2">
                ...
                <input type="number" class="form-control" name="modelsubcatId" value="{{$modelsubcategory->modelsubcatId }}" disabled>
            </div>

            <div class="mb-2">
                <label for="modelcatId" class="form-label">Category</label>

                <select name="modelcatId" id="modelcatId" class="form-control dropdown" >
            ...
            <div class="mb-2">
                ...
                <input type="text" name="modelsubcatName" class="form-control" value="{{$modelsubcategory->modelsubcatName }}">
                {{-- Error --}}
