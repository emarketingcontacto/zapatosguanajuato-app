...
<html lang="es">
    <head>
        ...
        {{-- seo --}}
            ...
            <title> Login | ZapatosGuanajuato.com</title>
            <link rel="canonical" href="https://zapatosguanajuato.com/User/login">
        {{-- end seo --}}
        ...
        @section('main-content')
            ...
            <div class="users-form-container">
                ...
                <form method="POST" action="{{route('User.authenticate')}}">
                    ...
                    <div class="user-password">
                        <a href="{{route('User.create')}}">Registro Nuevo Usuario</a>
                    </div>
                </form>
            </div>
        @endsection
