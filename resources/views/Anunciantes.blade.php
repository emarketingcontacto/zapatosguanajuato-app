<link rel="stylesheet" href="{{ URL::asset('css/advertisers.css') }}" />
...
<x-layout pageTitle='Anunciantes' pageDescription="Pagina de Anunciantes" keywords="Anunciantes">
    @section('main-content')
        ...
        <div class="main-container">
           ...
           <h1>Registro de Nuevos Negocio</h1>
        </div>
            <div class="advertiser-title">
                <h2>Anunciante con Nosotros: Haz Crecer tu Negocio</h2>
                <h3>Crea tu listado, llena el formulatrio y comienza a conectar con más clientes en linea</h3>
                <h3>¡Escoje un plan y empieza hoy! </h3>
                <h4>Sin contratos, Cancela cuando quieras</h4>
            </div>
            ...
            <div class="ad-table-buttons">
                ...
                <div class="col ad-head-premium">
                    ...
                    <a href="https://buy.stripe.com/bJe5kFalb7tLg6t7lv2VG01" id="btnAnual" class="btn-price" style="display: none">
                        Unirme
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-credit-card-fill" viewBox="0 0 16 16">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v1H0zm0 3v5a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7zm3 2h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1"/>
                        </svg>
